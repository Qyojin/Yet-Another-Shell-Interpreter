...
char * read_line() {
    ...
    if (ch>=32 && ch < 127) {
      ...
      if(cursor_index == line_length){
        ...
        cursor_index++;
          ...
          int where = cursor_index;
          char toInsert = ch;
          line_length++;

          //move cursor to the end of string
          int i;
          for(i = cursor_index; i < line_length; i++) {
            ch = 27;
            write(1, &ch, 1);
            ch = 91;
            write(1, &ch, 1);
  ...
  cursor_index = line_length;
	...
	write(1, line_buffer, line_length);
        ...
        //left arrow, move cursor to left by 1
        ...
        //right arrow, move cursor to right by 1
        //fprintf(stderr, "line length is: %d\n", bound_left);
        if(cursor_index <= line_length){
            cursor_index++;
           // if(bound_left == line_length)
            //  is_at_rightmost = 1;
            ch = 27;
            write(1, &ch, 1);
            ch = 91;
